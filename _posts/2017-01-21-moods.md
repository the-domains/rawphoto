...
keywords:
  ...
  - funeralband
description: >-
  I’m reviving Twin Peaks by watching it’s 3rd season (check it on this IMDB
  link). After so many years David Linch and Mark Frost decided to make it real
  again, and I’m thankful for that. For me this was a series that “made” my
  generation (ok…along with X Files and Crime Story, this last one also with a
  great opening theme). Angelo Badalamenti with all of it’s genius created a
  very beautiful main theme and soundtrack. This link is the only one that’s
  available on Spotify, and mixtures the original soundtrack (only Badalamenti’s
  themes) and the ones from the movie. If you use it, on Apple Music you can
  find and stream the original one.
inLanguage: en
app_links:
  ...
  - path: spotify/user/nelson.cristo/playlist/334xPTKxuImgW9UxdcZzKK
    ...
    type: android
title: moods…
datePublished: '2017-10-08T20:43:48.157Z'
dateModified: '2017-10-08T20:43:46.832Z'
via: {}
inFeed: false
hasPage: true
